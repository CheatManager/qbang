...
<h3 class="panel-title">手机号码反查系统</h3>
</div>
<div class="panel-body" style="text-align: center;">
<div class="list-group">
<div class="list-group-item list-group-item-warning" style="font-weight: bold;">
<span>输入手机号码即可绑定的QQ号码</span>
</div>
<div class="list-group-item list-group-item-info" style="font-weight: bold;">
<input class="form-control" id="input" placeholder="请输入手机号码">
</div>
			<marquee scrollamount="5" direction="left" align="Middle" style="font-weight: bold;line-height: 15px;font-size: 15px;color: #FF0000;">请输入需要查询的手机号码，然后点击查找！更多精品资源请访问官方发布页获取最新地址， 加入官方QQ群号获取最新接口地址更新！​</marquee>
<div class="list-group-item">
<a onclick="qbang('cha')" class="btn btn-block btn-primary" style="background: linear-gradient(to right,#b221ff,#14b7ff);">查找</a>

<a class="btn btn-block btn-primary" style="background: linear-gradient(to right,#5A5A5A,#5A5A5A);" href="https://jsdhw.com.cn/">#广告位内容展示</a>
<a class="btn btn-block btn-primary" style="background: linear-gradient(to right,#48C9B0,#28B463);" href="https://jsdhw.com.cn/">#广告位内容展示</a>
</div>
<div class="pc_acmsd"><center><a href="https://jsdhw.com.cn/" target="_blank"><img src="/static/images/1.gif" style="width:100%;Height:60px;border-radius: 5px;padding: 0px;margin-top: 0px;margin-bottom: 1px;" alt="广告合作联系站长QQ：2301858400"></a></center></div>
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr height="50">
                                <td>
                                    <a href="https://vip.qqcxdh.top/" class="btn btn-block btn-primary" target="_blank">批量查询</a>
                                
                                </td>
                                <td>
                                    <a href="https://jq.qq.com/?_wv=1027&k=vMhWG8hX" class="btn btn-block btn-primary" target="_blank">技术交流群</a>
                                </td>
                            </tr>
                            <tr height="50">
                                <td>
                                    <a href="http://qqcxdh.top/" class="btn btn-block btn-success" target="_blank">免费接口更新地址</a>
                                </td>
                                <td>
                                    <a href="https://jsdhw.com.cn/" class="btn btn-block btn-success" target="_blank">个人主页</a>
                          </td>
                            </tr>
                            <tr height="50">
                            ...
                            <tr height="50">
                                <td>
                                    <a href="http://wpa.qq.com/msgrd?v=3&uin=2301858400&site=qq&menu=yes" class="btn btn-block btn-danger" target="_blank">联系QQ号</a>
                                </td>
                                <td>
                                    <a href="http://wpa.qq.com/msgrd?v=3&uin=2301858400&site=qq&menu=yes" class="btn btn-block btn-danger" target="_blank">联系QQ号</a>
                                </td>
...
<div style="text-align:center">
            <a href="https://jsdhw.com.cn/" target="_blank"><span style="color:red">您的捐赠是我们网站运营下去的动力，如果本平台对您有用，就“点我”对我们进行捐赠吧！</span></a>
        </div>
</div>
</div>
...
var qq = $('#input').val();
if(mod=='cha'){
$url = 'https://api1.qqcxdh.top/qqphone.php?phone='+qq;
}
